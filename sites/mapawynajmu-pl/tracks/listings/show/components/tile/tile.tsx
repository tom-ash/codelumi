...
const ListerPhone = loadable(
  () => import('./components/lister-phone/lister-phone'),
);
const GoToLink = loadable(() => import('./components/go-to-link'));
const Heading = loadable(
  () => import('../../../common/components/heading/heading'),
);
...
const Items = loadable(
  () => import('./components/features-furnishings/features-furnishings'),
);
const Description = loadable(
  () => import('./components/description/description'),
);
import { togglePhone } from '../../../common/helpers/toggle-phone';
import { markListingAsViewed } from '../../../common/helpers/mark-as-viewed';
