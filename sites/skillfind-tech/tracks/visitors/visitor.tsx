...
import { useVisitor } from '../../../src copy/sites/shared/app/functions/store/use-visitor';
const PrivacyMonit = loadable(
  () => import('./components/administration/privacy-monit/privacy-monit'),
);
...
const TermsOfService = loadable(
  () => import('./components/administration/terms-of-service/terms-of-service'),
);
const CookiesPolicy = loadable(
  () => import('./components/administration/cookies-policy/cookies-policy'),
);
const PrivacyPolicy = loadable(
  () => import('./components/administration/privacy-policy/privacy-policy'),
);
const PrivacySettings = loadable(
  () => import('./components/administration/privacy-settings/privacy-settings'),
);
const PageIndex = loadable(
  () => import('./components/page/components/index/index'),
);
