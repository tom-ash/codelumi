...
import Breadcrumbs from '../../../../../common/components/support/render-node/components/breadcrumbs/breadcrumbs';
...
const selectAnswer: SelectAnswer = (attrs) => {
  ...
  const newAnswers = answers.map((answer) => {
    ...
    if (
      answer.position !== selectedPosition &&
  ...
  dispatch({
    type: 'data',
    value: { answers: newAnswers, isAnyAnswerSelected },
  });
};
        ...
        <div className="buttons">
          ...
          {isSubmitted && (
            <>
              ...
              <button className="next" onClick={() => getNewQuestion()}>
                <SVG name="dice" /> Next
              </button>
            </>
          )}
