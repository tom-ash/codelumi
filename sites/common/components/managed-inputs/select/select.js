...
export default class ManagedSelect extends ManagedInput {
  constructor(props) {
    ...
    this.onFocusCoverClickHandler =
      handlers.onFocusCoverClickHandler.bind(this);
  ...
  render() {
    ...
    const { focus, top, left, width, preSelected } = this.state;

    return (
      <div style={{ display }} className={this.containerClass + decorator}>
        <div
          onMouseOver={this.onMouseOverHandler}
          onMouseLeave={this.onMouseLeaveHandler}
        >
          <div onClick={this.onClickHandler}>
            <div className={this.labelClass + decorator}>{label}</div>
            <div
        ...
        {children}
        <div className={this.errorContainerClass + decorator}>{error}</div>
      </div>
    );
  }
}
