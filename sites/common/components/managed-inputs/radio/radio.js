...
export class ManagedRadio extends ManagedInput {
  constructor(props) {
    super(props);
    this.input = [];
    this.containerClass = this.classNames.container || 'managed-input radio';
    this.radioContainerClass =
      this.classNames.radioContainerClass || 'container';
  ...
  render() {
    ...
    return (
      <div style={{ display }} className={this.containerClass}>
        {radios.map((radio, index) => (
          <div
            className={`${this.radioContainerClass}${radio.value === checked ? ' checked' : ''}${decorator[index] ? decorator[index] : ''}`}
          ...
          >
            ...
            >
              {radio.value === checked && (
                <div
                  className={`${this.tickClass}${decorator[index] ? decorator[index] : ''}`}
                />
              )}
            </div>
            <input
