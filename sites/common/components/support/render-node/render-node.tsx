...
const TableOfContents = loadable(
...
const YouTubeEmbed = loadable(
  () => import('./components/youtube-embed/youtube-embed'),
);
...
const SkillfindTechIcon = loadable(
  () => import('../../../../sites/skillfind-tech/tracks/scaffold/icon/icon'),
);

const SkillfindTechLogo = loadable(
  () => import('../../../../sites/skillfind-tech/tracks/scaffold/logo/logo'),
);
...
export const RenderNode = (props: RenderNodeProps) => {
  try {
    ...
    if (node.Link) {
      ...
      return (
        <Link key={index} href={href} body={body} style={style} event={event} />
      );
    }
