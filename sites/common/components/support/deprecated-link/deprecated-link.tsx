...
import { scrollToFragment } from '../../../../src copy/sites/shared/app/functions/scrollers/scroll-to-fragment';
...
export const DeprecatedLink: LinkInterface = (props) => {
  ...
  const containerClassNames = customClassNames
  ...
  if ('linkKey' in props) {
    ...
    const onClick = () =>
      isAnchor
        ...
        : changeUrl({ href, retainQueryParams });
