...
const nodes = [
  ...
  },
  {
    ...
    pl: (
      <span>
        <strong>Serwis</strong> - serwis internetowy znajdujący się pod adresem <u>soundof.it</u>.
      </span>
    ),
    en: (
      <span>
        <strong>Service</strong> - a web service located at the address <u>soundof.it</u>.
      </span>
    ),
  },
  {
  ...
  },
  {
    ...
    pl: (
      <span>
        ...
        zamieszczenie zmian tych dokumentów w Serwisie pod adresem <i>soundof.it</i>. Zmiany te wchodzą w&nbsp;życie po
    ...
    en: (
      <span>
        ...
        <i>soundof.it</i>. The amendments are applicable after the lapse of the period of 14 days from their
        publication.
      </span>
    ),
  },
