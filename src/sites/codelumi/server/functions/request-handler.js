...
function handleRequest(req, res) {
  // if (req.hostname === 'codelumi.com' || req.hostname === 'www.codelumi.com') res.status(301).redirect(`https://${ROOT_DOMAIN}${req.originalUrl}`)
  // if (req.hostname === `www.${ROOT_DOMAIN}`) res.status(301).redirect(`https://${ROOT_DOMAIN}${req.originalUrl}`)
