...
export const provisions = [
  ...
  },
  {
    ...
    en: (
      <span>
        <strong>Listing</strong> - a record in the Service's database containing data regarding a given real
  ...
  },
  {
    ...
    en: (
      <span>
        ...
        in the Service's database, which enable that entity, upon meeting specified conditions, adding Listings in
  ...
  },
  {
    ...
    en: (
      <span>
        The Service is intended to present Listings regarding real estate lease/rent.
      </span>
    ),
  },
  {
  ...
  },
  {
    ...
    en: (
      <span>
        ...
        entrepreneur (Private Account) and/or b) an entity acting at adding of a Listing as an entrepreneur
        (Business Account).
      </span>
    ),
  },
  ...
  },
  {
    ...
    pl: (
      <span>
        Konsumentom oraz osobom fizycznym, co do których w relacjach z Administratorem znajdujde zastosowanie art. 385<sup>5</sup> polskiego kodeksu cywilnego, przysługuje prawo do odstąpienia od danej umowy z Administratorem w terminie 14 dni od jej zawarcia. Wykonanie tego prawa następuje poprzez wysłanie wiadomości email o odpowiedniej treści na adres <u>kontakt@mapawynajmu.pl</u>.
      </span>
    ),
    en: (
      <span>
        Consumers and individuals to whom Article 385<sup>5</sup> of the Polish Civil Code applies have the right to withdraw from a given agreement with the Administrator within 14 days from its conclusion. The exercise of this right is carried out by sending an email with the appropriate content to the address <u>kontakt@mapawynajmu.pl</u>.
      </span>
    ),
  },
  {
  ...
  },
  {
    ...
    en: (
      <span>
        Listings do not constitute offers within meaning of the Polish Civil Code, but constitute only invitations
  ...
  },
  {
    ...
    en: (
      <span>
        Listers are obligated to ensure that the content of the Listings added by them is congruent with law,
  ...
  },
  {
    ...
    en: (
      <span>
        The liability for the content of Listings, regarding - among others - their completeness, up-to-date status
        and correctness, lies solely with the respective Listers.
      </span>
    ),
  },
  {
    ...
    en: (
      <span>
        ...
        monthly gross rent through mutliplying the monthly net rent by 1.23. The Lister adding the Listing
  ...
  },
  {
    ...
    en: (
      <span>
        An added Listing stays active for the period of 60 days, unless, it is earlier deleted by the Lister or
        the Administrator. After the lapse of the activation period the Listing is not visible to Visitors,
        excluding the Lister. After 30 days from the end of the activation period the Listing is automatically
        deleted.
      </span>
    ),
  },
  {
    ...
    en: (
      <span>
        A Listing can at any time be deleted by the Lister.
      </span>
    ),
  },
  {
    ...
    en: (
      <span>
        A Listing can at any time be hidden by the Lister, which however does not impact the activation period.
        The hidden Listing is invisible to Visitors.
      </span>
    ),
  },
  {
    ...
    en: (
      <span>
        The Administrator is entitled to hide, de-activate and/or delete the Listing in case of determining of
        violation of these Terms of Service by the Lister.
      </span>
    ),
  },
  {
    ...
    en: (
      <span>
        A Listing can be promoted by the Lister.
      </span>
    ),
  },
  {
    ...
    en: (
      <span>
        Promoted Listings are displayed on the list before others and the icons of promoted Listings are displayed over others.
      </span>
    ),
  },
  {
  ...
  },
  {
    ...
    en: (
      <span>
        During promotional period adding and/or extending activation period of a Listing in the Service is gratuitous. After that period the price for adding and/or extending activation period of a Listing shall be provided in these Terms of Service.
      </span>
    ),
  },
  {
    ...
    tier: 'point',
    version: versions['2.0'],
    pl: <span>Początek oraz czas trwania okresu promocyjnego, o którym mowa w Punkcie 6.1, ustala Administrator w Regulaminie.</span>,
    en: <span>The beginning and duration of the promotional period referred to under Point 6.1 is determined by the Administrator in these Terms of Service.</span>,
  },
  {
    item: '6.3.',
    tier: 'point',
    ...
    en: (
      <span>
        The promotional period referred to under Point 6.1 commences on 19 June 2023.
      </span>
    ),
  },
  {
    ...
    en: (
      <span>
        Promotion of a Listing costs 29 PLN.
      </span>
    ),
  },
  {
  ...
  },
  {
    ...
    en: (
      <span>
        By making a payment within the Service, the Lister and/or their representative gives/give consent to processing of their personal data necessery for the payment process by the Administrator and the Administrator's partners to whom the Administrator delegates the payment process.
      </span>
    ),
  },
  {
    ...
    en: (
      <span>
        The commencement of rendering of a paid service by the Administrator takes place 14 days after its purchase by the Lister, unless the Lister expresses their will to commence rendering of the service before this date.
      </span>
    ),
  },
  {
    ...
    en: (
      <span>
        In the event of exercising the right of withdrawal as referred to under Point 4.3, and simultaneous expression of consent as referred to under Point 7.2, no refund is granted for the period during which the paid service was provided.
      </span>
    ),
  },
  {
  ...
  },
  {
    ...
    en: (
      <span>
        In case of termination of rendering of the services or their interruptions a Lister affected by that
        termination or interruption is entitled only to the proportional reimbursement of the amounts paid to the
        Administrator for those services.
      </span>
    ),
  },
  {
  ...
  },
  {
    ...
    en: (
      <span>
        Users acknowledge that adding of a Listing in the Service is connected with publication of their phone
  ...
  },
  {
    ...
    tier: 'point',
    version: versions['2.0'],
    pl: <span>Administrator ma prawo do zmiany Regulaminu oraz jego integralnych części, takich jak w szczególności, ale nie wyłącznie, Polityka Prywatności, Polityka Cookies oraz Cennik, w odniesieniu do:</span>,
    en: <span>The Administrator is entitled to amend these Terms of Service and their integral parts, including, without limitation, the Privacy Policy, the Cookies Policy and the Price List, with regard to:</span>,
  },
  {
    item: 'a)',
    tier: 'subpoint',
    ...
    en: <span>amendments required due to the mandatory provisions of law,
    </span>,
  },
  {
    item: 'b)',
    tier: 'subpoint',
    version: versions['2.0'],
    pl: <span>zmian wymaganych z uwagi na przeciwdziałanie nadużyciom oraz zapewnienie bezpieczeństwa Odwiedzających oraz Serwisu,</span>,
    en: <span>amendments required due to counteracting abuses and ensuring safety of the Visitors and the Service,</span>,
  },
  {
    item: 'c)',
    tier: 'subpoint',
  ...
  },
  {
    ...
    tier: 'subpoint',
    version: versions['2.0'],
    pl: <span>zmian w zakresie oraz cenach świadczenia dotychczasowych usług przez Administratora w ramach Serwisu,</span>,
    en: <span>amendments in the scope and prices of provisioning of the existing services by the Administrator within the Service,</span>,
  },
  {
    item: 'e)',
    tier: 'subpoint',
  ...
  },
  {
    ...
    tier: 'point',
    version: versions['2.0'],
    pl: <span>Zmiana Regulaminu wchodzi w życie w terminie wskazanym przez Administratora, jednakże nie krótszym niż 15 dni od dnia powiadomienia o tych zmianach poprzez ich publikację na stronie dostępnej pod adresem https://mapawynajmu.pl/regulamin, oraz w odniesieniu do dotychczasowych Użytkowników poprzez przesłanie informacji o tych zmianach na adres email Użytkownika podany przez Użytkownika i zapisany w Serwisie.</span>,
    en: <span>An amendment to the Terms of Service enters into force on the date indicated by the Administrator, however not shorter than 15 days from the date of notification about those amendments through their publication on the website available at https://mapawynajmu.pl/terms-of-service, and with regard to the existing Users through sending information about these changes to the User's email address provided by the User and saved within the Service.</span>,
  },
  {
    item: '10.3',
    tier: 'point',
    version: versions['2.0'],
    pl: <span>Zmiany Regulaminu wprowadzone z uwagi na bezwzględnie obowiązujące przepisy prawa lub z uwagi na przeciwdziałanie nadużyciom oraz zapewnienie bezpieczeństwa Odwiedzających oraz Serwisu mogą wejść w życie w terminie krótszym od przewidzianego w Punkcie 10.2, w tym nawet ze skutkiem natychmiastowym.</span>,
    en: <span>The amendments to the Terms of Service introduced due to the mandatory provisions of law and/or due to counteracting abuses and ensuring safety of the Visitors and the Service may enter into force in the period shorter than specified under Point 10.2, including even with immediate effect.</span>,
  },
  {
    item: '10.4',
    tier: 'point',
    version: versions['2.0'],
    pl: <span>Zmiany Regulaminu w odniesieniu do zakresu oraz cen świadczenia dotychczasowych usług przez Administratora w ramach Serwisu nie są stosowane w stosunku do odpłatnych usług aktywowanych przez Użytkownika przed tymi zmianami.</span>,
    en: <span>The amendments to the Terms of Service with regard the scope and prices of provisioning of the existing services by the Administrator within the Service are not applicable to the paid services activated by the User before these amendments.</span>,
  },
  {
    item: '10.5',
    tier: 'point',
    version: versions['2.0'],
    pl: <span>W przypadku braku akceptacji planowanych zmian Regulaminu, dotychczasowy Użytkownik uprawniony jest do wypowiedzenia umowy dotyczącej prowadzenia Konta w Serwisie ze skutkiem natychmiastowym, w terminie 15 dni od dnia otrzymania powiadomienia o tych zmianach, poprzez wysłanie wiadomości email o odpowiedniej treści na adres <u>kontakt@mapawynajmu.pl</u>, z zastrzeżeniem, że takie wypowiedzenie nie ma zastosowania do odpłatnch usług Administratora świadczonych w ramach serwisu aktywowanych przez Użytkownika przed tymi zmianami, aż do czasu zakończenia świadczenia tych usług.</span>,
    en: <span>In case of non-acceptance of the planned amendments to the Terms of Service, the existing User is entitiled terminate the agreement regarding Account maintenance within the Service with immediate effect, within the period of 15 days from the date of receiving notification of these changes, through sending an email message with the relevant content to the address <u>contact@mapawynajmu.pl</u>, with the reservation that such termination is not applicable to the paid services provisioned by the Administrator within the Service activated before these amendements, until the termination of provisioning of those services.</span>,
  },
  {
    item: '10.6',
    tier: 'point',
    version: versions['2.0'],
    pl: <span>Po wejściu w życie zmian Regulaminu aktywowanie nowej usługi wymaga ponownej akceptacji Regulaminu.</span>,
    en: <span>Once the amendments to the Terms of Service enter into force an activation of a new service requires re-accaptance of the Terms of Service.</span>,
  },
  {
    item: '11.',
    tier: 'header',
  ...
  },
  {
    ...
    tier: 'point',
    version: versions['2.0'],
    pl: <span>Spory wynikłe z niniejszego Regulaminu rozstrzygane będą przez sąd właściwy dla Administratora, chyba że bezwzględnie obowiązujące przepisy prawa określają inną właściwość.</span>,
    en: (
      <span>
