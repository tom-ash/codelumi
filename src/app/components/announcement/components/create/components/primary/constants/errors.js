export const errors = {
  ...
  floor: { polish: 'wybierz piętro', english: 'select floor' },
  totalFloors: { polish: 'wybierz całkowitą liczbę pięter', english: 'select total floors' },
  availabilityDateSelect: { polish: 'wybierz dostępność', english: 'provide availability' }
}