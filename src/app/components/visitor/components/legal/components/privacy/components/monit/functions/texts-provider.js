...
export function textsProvider(text) {
  ...
  switch (text) {
    ...
    case 'dataProcessing':
      return {
        pl: <span>Klikając OK wyrażasz zgodę na przetwarzanie Twoich danych osobowych przez nas oraz naszych Zaufanych Partnerów w calach prowadzenia statystyki oraz dostosowywania tresći marketingowych zgodnie z <u onClick={() => changeApp({ showVisitorPrivacyPolicy: true })}>Polityką Prywatności</u>. Jezeli chcesz nie wyrażać tej zgody lub ograniczyć jej zakres kliknij Ustawienia.</span>,
