...
export const text = [
  ...
  },
  {
    ...
    pl: <span><strong>Ogłoszenie</strong> - zapis w bazie danych Serwisu zawierający dane dotyczące danej nieruchomości, który, po spełnieniu określonych warunków, jest publicznie, czasowo dostępny w Serwisie, dla wszystkich Odwiedzających.</span>,
    en: <span><strong>Announcement</strong> - a record in the Service's database containing data regarding a given real estate, which, upon meeting specified conditions, is tenably publicly available within the Service to all Visitors.</span>
  },
  {
    item: 'd)', tier: 'subpoint', version: version['1.0'],
    pl: <span><strong>Konto</strong> - umowa pomiędzy Administratorem oraz danym podmiotem i odpowiadający tej umowie zapis w bazie danych Serwisu umożliwiające temu podmiotowi, po spełnieniu określonych warunków, dodawanie Ogłoszeń w bazie danych Serwisu.</span>,
    en: <span><strong>Account</strong> - an Agreement between the Administrator and a given entity and a corresponding record in the Service's database, which enable that entity, upon meeting specified conditions, adding Announcements in the Service's database. </span>
  },
  {
    ...
    en: <span><strong>Visitor</strong> - a person which obtained an access to the Service, for example through a web browser.</span>
  },
  {
  ...
  },
  {
    ...
    pl: <span><strong>Ogłoszeniodawca</strong> - podmiot, który dodał Ogłoszenie w Serwisie.</span>,
    en: <span><strong>Announcer</strong> - an entity, which added an Announcement in the Service.</span>
  },
  {
    item: '2.', tier: 'header', version: version['1.0'],
    pl: <span>Serwis</span>,
  ...
  },
  {
    ...
    pl: <span>Serwis przeznaczony jest do prezentowania Ogłoszeń odnoszących się do wynajmu biur oraz lokali użytkowych znajdujących się w obrębie m.st.&nbsp;Warszawy.</span>,
...

  {
    ...
    pl: <span>Konto w Serwisie może założyć wyłącznie podmiot posiadający status przedsiębiorcy działający samodzielnie lub poprzez osobę go&nbsp;reprezentującą.</span>,
  ...
  },
  {
    ...
    pl: <span>Ogłoszenia nie stanowią ofert w rozumieniu polskiego kodeksu cywilnego, a jedynie zaproszenia do rozpoczęcia negocjacji.</span>,
    en: <span>Announcements do not constitute offers within meaning of the Polish Civil Code, and constitute only invitations to commence negotiations.</span>
  },
  {
    item: '4.2.', tier: 'point', version: version['1.0'],
    pl: <span>Ogłoszeniodawcy odpowiedzialni są za zapewnienie, aby treść Ogłoszeń przez nich dodawanych była zgodna z prawem, dobrymi obyczajami oraz normami etycznymi.</span>,
    en: <span>Announcers are obligated to ensure that the content of the Announcements added by them is congruent with law, public decency and moral rules.</span>
  },
  {
    item: '4.3.', tier: 'point', version: version['1.0'],
    pl: <span>Odpowiedzialność za treść Ogłoszeń, dotyczącą między innymi ich pełności, aktualności oraz poprawności, ponoszą wyłącznie ich Ogłoszeniodawcy.</span>,
    en: <span>The liability for the content of Announcements, regarding - among others - their completeness, up-to-date status and correctness, lies solely with the respective Announcers.</span>
  },
  {
    item: '4.4.', tier: 'point', version: version['1.0'],
    pl: <span>W trakcie dodawania Ogłoszenia, na podstawie podawanego przez Ogłoszeniodawcę miesięcznego czynszu netto, algorytmy Serwisu automatycznie wyliczają miesięczny czynsz brutto, poprzez pomnożenie miesięcznego czynszu netto przez 1,23. Ogłoszeniodawca dodający dane Ogłoszenie potwierdza poprawność tych wyliczeń.</span>,
  ...
  },
  {
    ...
    pl: <span>Wyliczenia, o których mowa w Punktach 4.4 oraz 4.5 dokonywane są do dwóch miejsc po przecinku z zastosowaniem zaokrąglenia w górę.</span>,
    en: <span>The calculations referred to under Points 4.4 and 4.5 are made to two decimal points and with application of rounding up.</span>
  },
  {
    item: '4.7.', tier: 'point', version: version['1.0'],
    pl: <span>W okresie promocyjnym dodanie lub wydłużenie okresu aktywności Ogłoszenia w Serwisie jest nieodpłatne. Po tym okresie cena za dodanie lub wydłużenie okresu aktywności Ogłoszenia będzie ustalona zgodnie z cennikiem.</span>,
    en: <span>During promotional period adding and/or extending activation period of an Announcement in the Service is gratuitous. After that period the price for adding and/or extending activation period of an Annoucement shall be provided in the price list.</span>
  },
  {
  ...
  },
  {
    ...
    pl: <span>Ogłoszenie może być w każdym momencie ukryte przez Ogłoszeniodawcę, co pozostaje jednakże bez wpływu na okres aktywności. Ogłoszenie ukryte jest niewidoczne dla Odwiedzających.</span>,
    en: <span>An Announcement can at any time be hidden by the Announcer, which however does not impact the activation period. The hidden Announcement is invisible to Visitors.</span>
  },
  {
    item: '4.11.', tier: 'point', version: version['1.0'],
    pl: <span>Administrator uprawniony jest do ukrycia, deaktywacji lub usunięcia Ogłoszenia w przypadku stwierdzenia naruszenia Regulaminu przez Ogłoszeniodawcę.</span>,
    en: <span>The Administrator is entitled to hide, de-activate and/or delete the Annoucement in case of determining of violation of these Terms of Service by the Announcer.</span>
  },
  {
  ...
  },
  {
    ...
    pl: <span>Administrator uprawniony jest w każdym momencie do zaprzestania świadczenia usług poprzez Serwis, jak i do wprowadzania przerw w świadczeniu tych usług, z zastrzeżeniem  Punktu 5.2.</span>,
    en: <span>The Administrator is entitled at any time to terminate rendering of the services through the Service, and/or to interrupt rendering of those services, with the reservation of Point 5.2.</span>
  },
  {
    item: '5.2.', tier: 'point', version: version['1.0'],
    pl: <span>W przypadku zaprzestania świadczenia usług, bądź wprowadzenia przerw w ich świadczeniu, Ogłoszeniodawcy dotkniętemu takim zaprzestaniem lub przerwą przysługuje jedynie proporcjonalny zwrot kwoty zapłaconej Administratorowi za dodanie ogłoszenia dotkniętego takim zaprzestaniem lub przerwą.</span>,
    en: <span>In case of termination of rendering of the services or their interruptions an Announcer affected by that termination or interruption is entitled only to a proportional reimbursement of the amount paid to the Administrator for adding of the Annoucement affected by that termination or interruption.</span>
  },
  {
    item: '5.3.', tier: 'point', version: version['1.0'],
    pl: <span>Odpowiedzialność Administratora wobec danego Ogłoszeniodawcy w odniesieniu do danego Ogłoszenia ograniczona jest do wysokości opłaty poniesionej przez tego Ogłoszeniodawcę w odniesieniu do tego Ogłoszenia na rzecz Administratora.</span>,
  ...
  },
  {
    ...
    pl: <span>Podmiot tworzący Konto upoważania Administratora do przetwarzanie danych osobowych powiązanych z tym Kontem.</span>,
  ...
  },
  {
    ...
    pl: <span>Użytkownicy przyjmują do wiadomości, że dodanie Ogłoszenia w Serwisie wiąże się z nieograniczonym upublicznieniem ich nazwy (firmy) oraz numeru telefonu, podanych przy rejestracji Konta lub później.</span>,
    en: <span>Users acknowledge that the adding of the Announcement in the Service is connected with unlimited publication of their business name and phone numbers, provided during creation of the Account or later.</span>
  },
  {
  ...
  },
  {
    ...
    pl: <span>Wszelkie spory wynikłe z niniejszego Regulaminu rozstrzygane będą przez sąd właściwy dla Administratora.</span>,
    en: <span>Any disputes arising out of these Terms of Service shall be determined by the court having jurisdiction over the Administrator.</span>
  },
  {
    item: '7.3.', tier: 'point', version: version['1.0'],
    pl: <span>Niniejszy Regulamin wchodzi w życie z dniem 28 października 2019 r.</span>,
    en: <span>These Terms of Service are applicable as of 28th October 2019.</span>
  },
  {
    item: '7.4.', tier: 'point', version: version['1.0'],
    pl: <span>Administrator ma prawo do zmiany Regulaminu, Polityki Prywatności, Polityki Plików Cookies oraz Cennika poprzez zamieszczenie nowych tekstów jednolitych tych dokumentów w Serwisie pod adresem <i>www.warsawlease.pl</i>. Zmiany te wchodzą w&nbsp;życie po upływie okresu 14 dni od ich ogłoszenia.</span>,
    en: <span>The Administrator is authorised to amend these Terms of Service, the Privacy Policy, the Cookies Policy and the Pricing through publication of new unified texts of those documents within the Service under the address <i>www.warsawlease.pl</i>. The amendments are applicable after the lapse of the period of 14 days from their publication.</span>
  },
]
